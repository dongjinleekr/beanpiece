...
void ProcessorBuilder::initialize(JNIEnv *env) {
  setClass(env);

  Processor processor;
  const char* processorObjectName = processor.getCanonicalName();

  addNativeMethod("build", (void*)&buildProcessor, processorObjectName, kTypeString, NULL);
